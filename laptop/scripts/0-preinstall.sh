...
#
    ...
    mount -o ${MOUNT_OPTIONS},subvol=@var-cache ${partition3} /mnt/var/cache
    mount -o ${MOUNT_OPTIONS},subvol=@var-tmp ${partition3} /mnt/var/tmp
#
...
subvolumesetup () {
    echo -n "$enc_pass" | cryptsetup luksFormat /dev/vda2 -
...
# make directories home, .snapshots, var, tmp
    mkdir -p /mnt/{var/log,var/cache,var/tmp,var,tmp,.snapshots}
# mount subvolumes
    mountallsubvol
}
